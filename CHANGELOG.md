...
- reviewed the pi `0.78.0` changelog; the extension remains compatible with current command and clipboard behavior
...
- reviewed the pi `0.76.0` changelog; the extension remains compatible with current command and clipboard behavior

## 1.0.20 - 2026-05-23

- updated the local pi development baseline to `@earendil-works/pi-coding-agent` `0.75.5`, refreshed Node/tsx tooling, and regenerated the npm lockfile
- reviewed the pi `0.75.5` changelog and package guidance; the extension remains compatible with current command and clipboard behavior
...
- regenerated the npm lockfile against the current stable dependency graph
- reviewed the pi `0.71.1` changelog and confirmed the extension does not depend on removed providers, session-replacement objects, or TypeBox runtime migration surfaces
